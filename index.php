...
$routes = [
    ...
    ['POST', 'amis/{id}/notifications',   [AmisController::class, 'notifications']],
    ...
    ['POST', 'groupes/{id}/notifications',  [ConversationsController::class, 'notifications']],
    ...
    ['GET',  'travaux/nouveau',                [TravauxController::class, 'nouveau']],
    ...
    ['GET',  'travaux/{id}/taches/nouvelle',   [TravauxController::class, 'nouvelleTache']],
    ['POST', 'travaux/{id}/taches',            [TravauxController::class, 'ajouterTache']],
    ['GET',  'travaux/taches/{id}/modifier',   [TravauxController::class, 'formulaireTache']],
    ...
    ['GET',  'travaux/echeances/{id}/modifier', [TravauxController::class, 'formulaireEcheance']],
    ...
    ['POST', 'alternance/entreprise/retroplanning',     [AlternanceController::class, 'retroplanning']],
